...
public:
	...
	virtual ExprTreePtr &getLHS () {return nullDude;}
	virtual ExprTreePtr &getRHS () {return nullDude;}
	virtual ExprTreePtr &getChild () {return nullDude;}
