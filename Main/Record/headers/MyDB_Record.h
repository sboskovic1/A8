...
public:
	...
	// print this out; the width of each field is given in the vector
	void prettyPrint (vector <int> &widths);
	...
	// gets the type of a string to compile
	MyDB_AttTypePtr getType (string compileMe);
